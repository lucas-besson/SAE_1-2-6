...
public class MerelleGridLook extends GridLook {
    ...
    protected void createShape() {
        ...
        for (int i = 0; i < nbRows; i++) {
            ...
            //  last corners
            shape[5 * cellHeight][cellWidth] = "\u250C";
            shape[cellHeight][5 * cellWidth] = "\u250C";
            shape[cellHeight][(1 + 1) * cellWidth] = "\u2510";
            shape[5 * cellHeight][(5 + 1) * cellWidth] = "\u2510";
            shape[(1 + 1) * cellHeight][cellWidth] = "\u2514";
            ...
            shape[((cellHeight) + cellHeight / 2)][2 * cellWidth] = "\u251C";
            for (int j = 1; j < cellWidth; j++) {
                shape[cellHeight + cellHeight / 2][2 * cellWidth + j] = color + "\u2500" + ConsoleColor.RESET;
            }
            shape[((cellHeight) + cellHeight / 2)][3 * cellWidth] = "\u2524";

            shape[((cellHeight) + cellHeight / 2)][4 * cellWidth] = "\u251C";
            for (int j = 1; j < cellWidth; j++) {
                shape[cellHeight + cellHeight / 2][4 * cellWidth + j] = color + "\u2500" + ConsoleColor.RESET;
            }
            shape[((cellHeight) + cellHeight / 2)][5 * cellWidth] = "\u2524";
